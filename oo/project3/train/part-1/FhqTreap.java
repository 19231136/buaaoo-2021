public class FhqTreap {
    ...
    /*@ public normal_behavior
      @ assignable \nothing;
      @ ensures((val > key && rightTreap != null) ==> \result == new fhqTreap(val, weight, leftTreap.split_r(key), rightTreap));
      @ ensures((val > key && rightTreap == null) ==> \result == new fhqTreap(val, weight, null, rightTreap));
    ...
    /*@ public normal_behavior
      @ assignable \nothing;
      @ ensures((nodeA != null && nodeB != null && nodeA.weight < nodeB.weight) ==> \result == new fhqTreap(nodeA.val, nodeA.weight, nodeA.leftTreap, merge(nodeA.rightTreap, nodeB)));
      @ ensures((nodeA != null && nodeB != null && nodeA.weight >= nodeB.weight) ==> \result == new fhqTreap(nodeB.val, nodeB.weight, merge(nodeA, nodeB.leftTreap), nodeB.rightTreap));
      @ ensures((nodeA != null && nodeB == null) ==> \result == nodeA);
      @ ensures((nodeB != null && nodeA == null) ==> \result == nodeB);
      @ also
      @ public exceptional_behavior
      @ assignable \nothing;
      @ requires(nodeA == null || nodeB == null);
      @ signals (MergeNodeNullException e) nodeA == null && nodeB == null
     */
